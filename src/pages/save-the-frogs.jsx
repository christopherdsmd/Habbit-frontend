      ...
      <div className="donation-info">
        <div className="company-info">
          <div className="company-details">
            <a href="https://savethefrogs.com/" target="_blank" rel="noreferrer" className="company-name">Save the Frogs!</a>
        ...
        <div className="company-info">
          <div className="company-details">
            <a href="https://amphibianfoundation.org/" target="_blank" rel="noreferrer" className="company-name">The Amphibian Foundation</a>
        ...
        <div className="company-info">
          <div className="company-details">
            <a href="https://www.nwf.org/California/Our-Work/Refrogging-America" target="_blank" rel="noreferrer" className="company-name">National Wildlife Federation - Re-Frogging America</a>
